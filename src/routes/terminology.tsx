            ...
            {loading ? (
              ...
              <div className="space-y-3">
                {status === "auth-required" ? (
                  <div className="rounded-md border border-amber-300 bg-amber-50 p-4 text-sm text-amber-900 dark:border-amber-800 dark:bg-amber-900/30 dark:text-amber-100">
                    <div className="flex items-start gap-2">
                      <AlertTriangle className="mt-0.5 h-4 w-4 shrink-0" />
                      <div className="space-y-2">
                        <div className="text-base font-semibold">Authentication required</div>
                        <p>NHS Terminology Server credentials are pending.</p>
                        <ul className="list-disc space-y-1 pl-5 text-xs">
                          <li>No fake SNOMED results are shown.</li>
                          <li>Requests are routed through <code className="rounded bg-background/60 px-1 font-mono">/api/terminology</code> so credentials are not exposed in the browser.</li>
                          <li>Live SNOMED search, validation, and mapping will activate once system-to-system credentials are configured.</li>
                        </ul>
                      </div>
                    </div>
                  </div>
